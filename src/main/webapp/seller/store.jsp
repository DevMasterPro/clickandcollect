...
<div id="contact" class="container-fluid bg-grey">
  <h2 class="text-center">STORE REGISTER</h2>
  <div class="row ">
    <div class="col-sm-7">
      <div class="row ">
         ...
         <form role="form" method="post" action="/store">
          ...
          <div class="col-sm-6 form-group col-sm-push-5">
            ...
            <input class="form-control" id="sname" name="sname" placeholder="Store Name" type="text" required>
          </div>
      
          <div class="col-sm-6 form-group col-sm-push-5"">
            <input class="form-control" id="email"  name="email" placeholder="Type in Store Email" type="email" required>
          </div>
